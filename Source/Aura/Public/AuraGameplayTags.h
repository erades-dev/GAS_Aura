...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Debuff_Stat_Chance);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Debuff_Stat_Damage);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Debuff_Stat_Frequency);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Debuff_Stat_Duration);
